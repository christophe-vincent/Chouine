...
Announce::Announce(Card::Color _color, AnnounceType _type, bool _trump, CardList& _cards):
   m_Color(_color), m_Announce(_type), m_IsTrump(_trump), m_Cards(_cards)
{
   //TODO computeScore();
}
